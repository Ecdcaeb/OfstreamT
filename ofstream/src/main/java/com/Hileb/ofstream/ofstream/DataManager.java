...
public class DataManager {
    public List<IDataOfstream> ALL=new ArrayList<IDataOfstream>();
    public HashMap<String, List<IDataOfstream>> MAP=new HashMap<String, List<IDataOfstream>>();
    ...
    public void register(String modid,IDataOfstream dataOfstream){
        ...
        if (MAP.containsKey(modid)){
            ...
            ArrayList<IDataOfstream> list=new ArrayList<IDataOfstream>();
