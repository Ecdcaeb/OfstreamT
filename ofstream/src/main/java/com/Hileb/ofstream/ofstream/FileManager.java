...
public class FileManager {
    public static List<OfstreamRegisterObject> REGISTER=new ArrayList<OfstreamRegisterObject>();
            ...
            for(String modId:objects.ofstreamHashMap.keySet()) {
                ...
                try {
                    ...
                    if (Minecraft.getMinecraft().thePlayer != null)
                        Minecraft.getMinecraft().thePlayer.sendChatMessage("Ofstream " + dataId + " successfully!");
